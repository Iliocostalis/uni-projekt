...
enum {
	...
	AF_STATE = 35,
	AF_PAUSE_STATE = 36,
	AE_PRECAPTURE_TRIGGER = 37,
	NOISE_REDUCTION_MODE = 38,
	COLOR_CORRECTION_ABERRATION_MODE = 39,
	AE_STATE = 40,
	AWB_STATE = 41,
	SENSOR_ROLLING_SHUTTER_SKEW = 42,
	LENS_SHADING_MAP_MODE = 43,
	SCENE_FLICKER = 44,
	PIPELINE_DEPTH = 45,
	MAX_LATENCY = 46,
	TEST_PATTERN_MODE = 47,
};
